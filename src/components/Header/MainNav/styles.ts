...
export const MainNavItem = motion.custom(styled(Link)`
  ${tw`relative text-indigo-900 border-b border-transparent hover:text-indigo-900 ml-0 sm:ml-8 mt-3 sm:mt-0 mr-1`};
  width: max-content;
...
export const LinkItem = motion.custom(styled.a`
